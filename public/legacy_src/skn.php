          ...
          <div class="col-lg-12" data-aos="fade-left" data-aos-delay="100">
            <form action="cek_nama.php" method="post" role="form">
              <div class="row">
                <div class="col-md-4 form-group mt-3">
                    ...
                    <input type="hidden" name="jenis" class="form-control" id="jenis" value="skn" required >
                </div>
                <div class="col-md-6 form-group mt-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                          <a href="skn.php" class="btn btn-danger btn-sm">Reset Form</a>
                        </div>
                    </div>
                </div>
              </div>
            ...
            <?php 
              if(empty($_GET['no_rekening'])){ 
                ...
                ?>
              <hr>
                <form action="sknkeun.php" method="post" role="form">
                    <div class="row">
                        ...
                        <div class="col-lg-6 card"> 
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mt-3">
                                    ...
                                    <input type="text" name="biaya_trf" class="form-control" id="biaya_trf" value="5000" readonly required>
                                    <input type="hidden" name="jenis_trf" class="form-control" id="jenis_trf" value="SKN" readonly required>
                                </div>
                                <div class="col-md-6 form-group mt-3">
                    ...
                    <div class="text-center"><button class="btn btn-warning" onclick="cek_saldo_trf('saldo1','nominal1','minimum','biaya_trf')"	 type="submit"><h5>Transfer SKN</h5></button></div>
                </form>
            <?php } ?>
          </div>
        </div>
