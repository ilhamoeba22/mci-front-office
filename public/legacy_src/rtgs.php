          ...
          <div class="col-lg-12" data-aos="fade-left" data-aos-delay="100">
            <form action="cek_nama.php" method="post" role="form">
              <div class="row">
                <div class="col-md-4 form-group mt-3">
                    ...
                    <input type="hidden" name="jenis" class="form-control" id="jenis" value="rtgs" required >
                </div>
                <div class="col-md-6 form-group mt-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                          <a href="rtgs.php" class="btn btn-danger btn-sm">Reset Form</a>
                        </div>
                    </div>
                </div>
              </div>
            ...
            <?php 
              if(empty($_GET['no_rekening'])){ 
                ...
                ?>
              <hr>
                <form action="rtgskeun.php" method="post" role="form">
                    <div class="row">
                        <div class="col-lg-6 card"> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 form-group mt-3">
                                    ...
                                    value="<?php if(empty($_GET['no_rekening'])){ echo "Kosong"; }else{ echo $_GET['no_rekening']; }  ?>">
									<input type="hidden" name="alamat_" class="form-control kalimat" id="alamat_" required readonly 
                                    value="<?php if(empty($_GET['alamat_'])){ echo "Kosong"; }else{ echo $_GET['alamat_']; }  ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 form-group mt-3">
                                    ...
                                    value="<?php if(empty($_GET['nama_nasabah'])){ echo "Kosong"; }else{ echo $_GET['nama_nasabah']; }  ?>">
                                </div>
                                <div class="col-md-6 form-group mt-3">
                                    <label for="saldo">Saldo Saat Ini</label>
                                    <input type="password" name="saldo" class="form-control huruf" id="saldo"  required disabled
                                    value="<?php if(empty($_GET['saldo_akhir'])){ echo "Kosong"; }else{ echo number_format($_GET['saldo_akhir'],2,",","."); }  ?>">

                                    <input type="hidden" name="saldo1" class="form-control" id="saldo1"  required 
                                    value="<?php if(empty($_GET['saldo_akhir'])){ echo 0; }else{ echo $_GET['saldo_akhir']; }  ?>">
                        ...
                        <div class="col-lg-6 card"> 
                            ...
                            <div class="form-group mt-3">
                                <input type="hidden" name="alamat_tujuan" class="form-control kalimat" id="alamat_tujuan" placeholder="Alamat Tujuan" value="- " required>
                            </div>
                            <div class="form-group mt-3">
                                <label for="kota_tujuan">Kota Bank Tujuan</label>
                                <select name="kota_tujuan" id="kota_tujuan" class="form-control select2" required>
                                    <option value=""> ---- Pilih Kota Tujuan ---- </option>
                                    <?php 
                                        require 'connection.php';
                                        $sql1 = "select * from tbl_kota;"; 
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mt-3">
                                    ...
                                    <input type="text" name="biaya_trf" class="form-control" id="biaya_trf" value="50000" readonly required>
                                    <input type="hidden" name="jenis_trf" class="form-control" id="jenis_trf" value="RTGS" readonly required>
                                </div>
                                <div class="col-md-6 form-group mt-3">
                    ...
                    <div class="text-center"><button class="btn btn-warning" onclick="cek_saldo_trf('saldo1','nominal1','minimum','biaya_trf')" type="submit"><h5>Transfer RTGS</h5></button></div>
                </form>
            <?php } ?>
          </div>
        </div>
