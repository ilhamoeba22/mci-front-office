          ...
          <form action="cek_nama.php" method="post" role="form">
              <div class="row">
                ...
                <div class="col-md-4 form-group mt-3">
                    ...
                    <input type="text" name="cek_norek2" class="form-control numeric" id="cek_norek2" placeholder="No Rekening" required 
                    onkeyup="cek_pinbuk('cek_norek','cek_norek2')">
                    <input type="hidden" name="jenis" class="form-control" id="jenis" value="pinbuk" required >
                </div>
                <div class="col-md-2 form-group mt-3">
                    <label for="">Cek No Rekening</label>
                    <div class="row">
                        <div class="col-lg-6"><button class="btn btn-warning btn-sm" type="submit">Cek Data</button></div>
                        <div class="col-lg-6">
                          <a href="pinbuk.php" class="btn btn-danger btn-sm">Reset Form</a>
                        </div>
                    </div>
                </div>
              </div>
            ...
            <hr>
            <?php 
              if(empty($_GET['no']) || empty($_GET['no2'])){ 
                if(empty($_GET['msg'])){ 
                ...
                ?>
              <hr>
                <form action="pinbukkeun.php" method="post" role="form">
                    <div class="row">
                            <div class="col-lg-6 card"> 
                                ...
                                <div class="row">
									...
									value="<?php if(empty($_GET['nama_nasabah'])){ echo "Kosong"; }else{ echo $_GET['nama_nasabah']; }  ?>" readonly>
                                </div>
                                <div class="col-md-4 form-group mt-1">
									...
									value="<?php if(empty($_GET['no_hp'])){ echo "Kosong"; }else{ echo $_GET['no_hp']; }  ?>" readonly>
                                </div>
                                    <div class="form-group mt-3">
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 card"> 
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group mt-3">
                                        <label for="no_rek">No Rekening</label>
                                        <input type="text" name="no_rek" class="form-control numeric" id="no_rek" required readonly 
                                        value="<?php if(empty($_GET['no'])){ echo "Kosong"; }else{ echo $_GET['no2']; }  ?>">
                                    </div>
                                    <div class="col-md-6 form-group mt-3">
                                        <label for="nama">Nama Rekening</label>
                                        <input type="text" name="nama" class="form-control huruf" id="nama" required readonly
                                        value="<?php if(empty($_GET['nama'])){ echo "Kosong"; }else{ echo $_GET['nama2']; }  ?>">
                                    </div>
                                </div>
                                <div class="form-group mt-3">
                                    <label for="bank_tujuan">Bank Tujuan</label>
                                    <select name="bank_tujuan" id="bank_tujuan" class="form-control" readonly required>
                                        <option value="BPRS MCI"> BPRS MCI </option>
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group mt-3">
                                        <input type="hidden" name="biaya_trf" class="form-control" id="biaya_trf" value="0" readonly required>
                                        <input type="hidden" name="jenis_trf" class="form-control" id="jenis_trf" value="PINBUK" readonly required>
                                    </div>
                                    <div class="col-md-6 form-group mt-3">
                                        <input type="hidden" name="hp_penerima" class="form-control angkatok" id="hp_penerima" placeholder="No HP Penerima" value="0" required>
                                    </div>
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="text-center"><button class="btn btn-warning" onclick="cek_saldo_trf('saldo1','nominal1','minimum','biaya_trf')" type="submit"><h5>Transfer Pinbuk</h5></button></div>
                </form>
            <?php } ?>
          </div>
        </div>
