          ...
          <form action="list_done.php" method="post" role="form">
            <?php while($row = $result->fetch_assoc()) { ?>
              <div class="row">
                ...
                <div class="form-group mt-3">
                    <label for="berita">Berita untuk Penerima</label>
                    <textarea name="berita" class="form-control" id="berita"  rows="3" placeholder="Berita untuk penerima" readonly><?php echo $row['berita']; ?></textarea>
                </div>
                <div class="form-group mt-3">
                    <label for="tujuan">Tujuan Transaksi</label>
                    <input type="text" name="tujuan" class="form-control" id="tujuan" placeholder="Tujuan Transaksi" value="<?php echo $row['tujuan']; ?>" readonly>
                </div>
                <div class="col-md-6 form-group mt-3">
                    <label for="nama_penyetor">Nama Penyetor</label>
                    <input type="text" name="nama_penyetor" class="form-control" id="nama_penyetor" placeholder="Nama Penyetor" value="<?php echo $row['nama_penyetor']; ?>" readonly>
                </div>
                <div class="col-md-6 form-group mt-3">
                    <label for="hp_penyetor">No HP Penyetor</label>
                    <input type="tel" name="hp_penyetor" class="form-control" id="hp_penyetor" placeholder="No HP Penyetor" value="<?php echo $row['hp_penyetor']; ?>" readonly>
                    ...
                    <input type="hidden" name="jns_trx" class="form-control "  value="setor" >
                </div>
              </div>
              ...
              <div class="row">
				  ...
				  <div class="col-md-2 form-group mt-3">
                      <div class="text-center"><a target="_blank" href="print_data.php?iid=<?php echo$row['token']; ?>" class="btn btn-primary" type="button"><h5>Print </h5></a></div>
                  </div>
              </div>
            <?php } ?>
            </form>
