          ...
          <div class="col-lg-12" data-aos="fade-left" data-aos-delay="100">
            <form action="cek_nama.php" method="post" role="form">
              <div class="row">
                <div class="col-md-6 form-group mt-3">
                    ...
                    <input type="hidden" name="jenis" class="form-control" id="jenis" value="setor" required >
                </div>
                <div class="col-md-6 form-group mt-3">
            ...
            <?php
              if(!isset($_SESSION['transfer_data'])){ 
                ...
                echo "SILAKAN MELANJUTKAN ISI FORM SETOR ANDA"; 
                ?>
                
              <hr>
              <form action="setorkeun.php" method="post" role="form">
                <div class="row">
                  ...
                  <div class="col-md-2 form-group mt-3">
                      ...
                      value="<?php if(empty($saldo_akhir)){ echo "Kosong"; }else{ echo number_format($saldo_akhir,2,",","."); }  ?>">

                      <input type="hidden" name="saldo1" class="form-control" id="saldo1"  required 
                      value="<?php if(empty($saldo_akhir)){ echo 0; }else{ echo $saldo_akhir; }  ?>">
                  ...
                  <div class="col-md-6 form-group mt-3">
                      ...
                      <input type="text" name="nama_penyetor" class="form-control huruf" id="nama_penyetor" placeholder="Nama Penyetor" required>
                  </div>
                  <div class="col-md-6 form-group mt-3">
                      <label for="hp_penyetor">No HP Penyetor</label>
                      <input type="tel" name="hp_penyetor" class="form-control angkatok" id="hp_penyetor" placeholder="No HP Penyetor" required>
                  </div>
				  <!-- <div class="col-md-3 form-group mt-3">
                      <label for="nama_penyetor">No ID Penyetor</label>
                      <input type="text" name="noid_penyetor" class="form-control angkatok" id="noid_penyetor" placeholder="ID Penyetor" required>
                  </div>
                  <div class="col-md-3 form-group mt-3">
                      <label for="hp_penyetor">Alamat Penyetor</label>
                      <input type="tel" name="alamat_penyetor" class="form-control kalimat" id="Alamat_penyetor" placeholder="Alamat Penyetor" required>
                  </div> -->
                </div>
                
                <div class="my-3 mt-3">
                </div>
                <div class="text-center"><button class="btn btn-warning" type="submit"><h5>Setor Tunai</h5></button></div>
              </form>
            <?php } ?>
