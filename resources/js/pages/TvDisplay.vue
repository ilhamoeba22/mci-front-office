        ...
        <div class="flex flex-col h-screen w-full relative z-10">
            ...
            <div class="h-16 flex items-center justify-between px-10 border-b border-slate-200 dark:border-white/10 bg-white/40 dark:bg-slate-900/60 backdrop-blur-md shadow-sm dark:shadow-lg transition-colors duration-500">
                ...
                <div class="text-right">
                    <div class="text-2xl font-mono font-bold text-slate-700 dark:text-slate-200 tracking-[0.1em] drop-shadow-sm dark:drop-shadow-md transition-colors leading-tight">
                        {{ currentTime }}
                    </div>
                    <div class="text-sm text-slate-500 dark:text-slate-400 uppercase font-semibold tracking-[0.15em] transition-colors leading-none">
                        {{ currentDate }}
                    </div>
                </div>
            </div>
